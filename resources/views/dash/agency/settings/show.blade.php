...
<div class="grid gap-6 sm:grid-cols-2 lg:grid-cols-3 p-10">
    ...
    <a href="/dashboard/<?= $uuid ?>/settings/api" class="group block rounded-2xl bg-white p-6 transform transition-all duration-200 hover:outline-none hover:ring-2 hover:ring-offset-2 hover:ring-yellow-500">
        <div class="flex items-start gap-4">
            <div class="flex-shrink-0">
            ...
            <div>
                ...
                <p class="mt-1 text-sm text-gray-600">Gestisci l'interazione con servizi esterni, come il tuo sito web e altro</p>
            </div>
        </div>
    </a>

    <a href="/dashboard/<?= $uuid ?>/settings/agency" class="group block rounded-2xl bg-white p-6 transform transition-all duration-200 hover:outline-none hover:ring-2 hover:ring-offset-2 hover:ring-red-500">
        <div class="flex items-start gap-4">
            <div class="flex-shrink-0">
    ...
    <a href="/dashboard/user" class="group block rounded-2xl bg-white p-6 transform transition-all duration-200 hover:outline-none hover:ring-2 hover:ring-offset-2 hover:ring-indigo-500">
        <div class="flex items-start gap-4">
            <div class="flex-shrink-0">
