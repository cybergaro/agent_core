        ...
        <div class="flex flex-col w-full">
            ...
            >
                ...
                <?php foreach ($ape as $single) { ?>
                    <option value="<?= $single?>" <?= $single == $unit->ape ? "selected" : "" ?>><?= $single?></option>
                <?php } ?>
            </select>
        </div>
        ...
        <div class="flex flex-col w-full">
            ...
            >   
                ...
                <?php foreach ($heatingSystemManagment as $single) { ?>
                    <option value="<?= $single ?>" <?= $unit->heating_system_management == $single ? "selected" : ""?>><?= __("property.".$single) ?></option>
                <?php } ?>
            </select>
        </div>
        ...
        <div class="flex flex-col w-full">
            ...
            >   
                ...
                <?php foreach ($heatingSystemType as $single) { ?>
                    <option value="<?= $single ?>" <?= $unit->heating_system_type == $single ? "selected" : ""?>><?= __("property.".$single) ?></option>
                <?php } ?>
            </select>
        </div>
    ...
    <div class="flex flex-col w-full">
        ...
        >   
            ...
            <?php foreach ($heatingSystemPower as $single) { ?>
                <option value="<?= $single ?>" <?= $unit->heating_system_power == $single ? "selected" : ""?>><?= __("property.".$single) ?></option>
            <?php } ?>
        </select>
    </div>
</div>